...
def run_experiment(dataset_name, host_tree_file, virus_tree_file, interaction_tsv, target_flips):
    ...
    flip_cost_matrix = 1/parse_phist_costs(f"../../HostPredictionReview/Benchmark/Task2-MetaHiC/Results/phist/common_kmers_{dataset_name}.csv", hosts, parasites)
...
summary_df.to_csv("experiments/flip_accuracy_summary_phist.tsv", sep="\t", index=False)
print("\n📊 Summary saved to experiments/flip_accuracy_summary_phist.tsv")
print(summary_df)
