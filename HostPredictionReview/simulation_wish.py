...
def run_experiment(dataset_name, host_tree_file, virus_tree_file, interaction_tsv, target_flips):
    ...
    flip_cost_matrix = parse_wish_costs(
        f"../../HostPredictionReview/Benchmark/Task2-MetaHiC/Results/wish/{dataset_name}.matrix",
        hosts, parasites
    )
...
summary_df.to_csv("experiments/flip_accuracy_summary_wish.tsv", sep="\t", index=False)
print("\n📊 Summary saved to experiments/flip_accuracy_summary_wish.tsv")
print(summary_df)
